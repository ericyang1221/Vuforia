    ...
    SampleAppMenuInterface
{
    ...
    private static final String kAccessKey = "9792610f35f647e53e7c4a48474cbe60d9adaa71";
    private static final String kSecretKey = "c7e322f3b18531643e1809ddf769f5668104accb";
    ...
    public void onQCARUpdate(State state)
    {
        ...
        } else if (statusCode == TargetFinder.UPDATE_RESULTS_AVAILABLE)
        {
            ...
            if (finder.getResultCount() > 0)
            {
                ...
                String metaData = result.getTargetName();
                if(metaData!=null){
                    if(metaData.startsWith("op")){
                        Uri uri = Uri.parse("http://op.mobage.cn/");
                        Intent intent = new Intent(Intent.ACTION_VIEW,uri);
                        startActivity(intent);
                    }else if(metaData.startsWith("tf")){
                        Uri uri = Uri.parse("http://tf.mobage.cn/");
                        Intent intent = new Intent(Intent.ACTION_VIEW,uri);
                        startActivity(intent);
                    }
                }
